...
@Component({ selector: 'app-work-experience', standalone: false, templateUrl: './work-experience.html' })
export class WorkExperience implements OnInit {
  ...
  eliminar(id: string) {
    if(confirm('¿Eliminar experiencia?')) this.workService.delete(id);
  }
}