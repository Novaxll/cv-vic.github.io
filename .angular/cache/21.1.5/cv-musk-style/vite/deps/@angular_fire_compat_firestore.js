import {
  ...
  ɵlazySDKProxy,
  ɵzoneWrap
} from "./chunk-RWFPC56O.js";
import {
  isPlatformServer
} from "./chunk-GFTCUTUL.js";
import {
  EnvironmentInjector,
  Inject,
  Injectable,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name3, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-RSN2U2LS.js"))), map(() => ɵfirebaseAppFactory(options, zone, name3)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
